...
def attack(char_name: str, char_class: str) -> str:
    """Print messages about attack scores."""
...
def defence(char_name: str, char_class: str) -> str:
    """Print messages about defence scores."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Print character's special skill and prints messages about it."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Start the game and starts other functions.
    attack, defence and spetial.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Allow user to select player and prints according messages."""
